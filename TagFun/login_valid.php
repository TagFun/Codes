...
//---------------------------- STARTING SESSION AND CONNECTING TO DATABASE--------------------------------
	...
	if(!$DB)
	{
		die("MySQL ei voinut yhdistää ietokantaan");
	}
	...
	// Kryptataan salasana
	// Tämän jälkeen käytetään $Encrypt_salasana
	...
	// Käyttäjätnnuksen ja salasanan tarkistaminen tietokannasta
